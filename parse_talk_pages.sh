...
# scrape file
echo python ~/projects/code-switching/wiki/python-mwchatter/scrapeTalkPages.py $UNZIPDIR/$UNZIPFILE $OUTDIR
python ~/projects/code-switching/wiki/python-mwchatter/scrapeTalkPages.py $UNZIPDIR/$UNZIPFILE $OUTDIR
